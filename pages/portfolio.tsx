  ...
  return (
    <>
      ...
      <Container className="cap-width-lg">
        ...
        <PortfolioSection name="Machine learning models" id="machine-learning">
          <>
        ...
        <PortfolioSection name="APIs and microservices" id="apis">
          <>
            Python/Flask with SQLite
            <ul className="mb-1">
              <li>
                <a href="https://library-python.tymick.me">Personal library</a>
              </li>
              <li>
        ...
        <PortfolioSection name="Full-stack web apps" id="full-stack">
        ...
        <PortfolioSection name="WordPress themes" id="wordpress">
          <a href="https://ty-mick-wordpress-port.000webhostapp.com">
            Personal site WordPress port
          </a>
        </PortfolioSection>

        <PortfolioSection name="Single-page apps" id="single-page-apps">
          <>
            React
            <ul className="mb-1">
              <li>
              ...
              <li>
                <a href="https://codepen.io/TyMick/full/BaBVeVO">Calculator</a>
              </li>
              <li>
        ...
        <PortfolioSection name="React hooks" id="react-hooks">
