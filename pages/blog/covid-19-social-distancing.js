...
import { Figure, Image } from "../../components";

export default function Covid19SocialDistancing() {
  return (
    <>
      {/* prettier-ignore */}
      <Head>
        ...
        <meta property="og:image" content="https://tymick.me/images/outbreak-scenarios-july.png" />
      ...
      >
        ...
        <p>
          The article does say that the &ldquo;No control measures&rdquo;
          scenario is unlikely, since people and governments are already at
          least doing <em>something</em>, but here&rsquo;s how it describes #2
          and #3: &ldquo;A second scenario envisions what would happen with some
          control measures, such as partial adherance to social distancing
          guidlines and a patchwork of government-imposed restrictions on work,
          travel, and dining out. A third envisions severe control measures:
          strict adherance across the country to social distancing, working
          remotely, closing schools and restaurants and banning large
          gatherings.&rdquo;
        </p>
        <p>
          #2 sounds like the current situation in this country, and those maps
          by July and August look <em>awful</em>. I <em>really</em> hope the
          country as a whole moves to more severe control measures so our
          infection map ends up looks more like #3. But it&rsquo;s going to be
          tougher to compel people to stay home here in a Western society where
          the importance of the individual is praised above the importance of
          the group, as opposed to the more naturally group-oriented thinking of
          East Asian societies.
        </p>
        <p>
          But regardless of the infection rate, how long are we going to have to
          isolate ourselves? China&rsquo;s infection rate started decreasing
          after two months, but they&rsquo;re still having to use a lot of
          restrictions to keep the virus at bay. Scientists also don&rsquo;t
          know for sure yet whether surviving a COVID-19 infection makes you
          immune. <cite>The Washington Post</cite> sums up{" "}
          <a href="https://www.washingtonpost.com/health/2020/03/16/social-distancing-coronavirus/">
            the potential timeline
          </a>{" "}
          pretty well: &ldquo;So it&rsquo;s possible, even most likely, that
          after U.S. cases peak, Americans will still have to maintain some
          measures — such as isolating the infected, constant hand-washing, some
          degree of social distancing — until a viable vaccine is developed,
          which could take 12 to 18 months.&rdquo;
        </p>
        <p>
        ...
        <p>
          So what does that mean for Corrie and me as full-time nomads? We live
          in an RV and have no stationary home to go back to. We&rsquo;d already
          ...
          lands, we have to move every 2 weeks. We&rsquo;re hearing from the
          nomad community on social media that governments are closing off a lot
          of public lands now, but even if we could continue to find some places
          ...
          irresponsible. In the small but existing chance that we do get the
          virus (we still need to go into town for groceries and water) we could
          take it with us to a new city that wouldn&rsquo;t have had it
          otherwise.
        </p>
        <p>
        ...
        <p>
          ...
          some good friends of ours who are also in their late twenties. They
          also live in a more rural area, and we&rsquo;d rather add the (small)
          burden of our presence in a community to as few people as possible.
        </p>
        <p>
          These friends also have small children in the home, but amazingly, so
          far not a single child under the age of 10 has died from COVID-19 in
          the entire world. Surprising, since kids are usually more vulnerable
          to the flu, but quite a relief.
        </p>
        <p>
          Finally, to make absolutely sure we don&rsquo;t pass along an
          infection unknowingly caught at a gas station or auto mechanic along
          the way despite our best efforts, Corrie and I are going to remain
          isolated in our RV for our first two weeks at our fiends&rsquo; house,
          because symptoms can take{" "}
          <a href="https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html">
            up to 14 days
          </a>{" "}
          to appear after exposure to this coronavirus. After that point, we can
          be confident that our risk profile is identical to that of our
          friends, since it won&rsquo;t make a difference which member of the
          household does the grocery runs.
        </p>
        ...
        <p>
          ...
          putting them onto my pantry shelves? According to the experts,
          probably not.
        </p>
        <p>
          ...
          making signs to post around the house to remind me. And this
          6-year-old taught me{" "}
