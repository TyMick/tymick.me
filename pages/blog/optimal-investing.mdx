export const metadata = {
  ...
  date: "2017-07-29",
  canonicalUrl:
    "https://medium.com/@TyMick/simple-effective-investing-4268a1e6229c",
  excerpt:
...
import headerImg from "../../public/images/pexels-pixabay-164474.jpg";

<Figure className="full-width mt-2 mb-4">
  <FigureImage src={headerImg} className="d-block mx-auto" priority />
</Figure>
...
[a fantastic thought experiment](https://web.archive.org/web/20170727051304/http://www.thesimpledollar.com/why-fees-matter/)
...
[market](https://web.archive.org/web/20170720184807/https://www.thesimpledollar.com/why-dont-professional-investors-beat-the-market/).
