export const metadata = {
  ...
  socialLinks: {
    ...
    linkedin:
      "https://www.linkedin.com/posts/tymick_building-a-neural-network-to-predict-loan-activity-6694323719113912320-SW7j",
  },
  syndicated: {
    medium:
...
or
[GitHub](https://github.com/TyMick/loan-risk-neural-network/blob/master/models/loan-risk-neural-network.ipynb "loan-risk-neural-network/loan-risk-neural-network.ipynb at master · TyMick/loan-risk-neural-network").
