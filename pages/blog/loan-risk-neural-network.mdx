export const metadata = {
  ...
  syndicated: {
    ...
    dev:
      "https://dev.to/tymick/building-a-neural-network-to-predict-loan-risk-3k1f",
    hackerNoon:
...
or
[GitHub](https://github.com/TyMick/loan-risk-neural-network/blob/master/models/loan-risk-neural-network.ipynb "loan-risk-neural-network/loan-risk-neural-network.ipynb at master · tywmick/loan-risk-neural-network").
...
[on GitHub](https://github.com/TyMick/loan-risk-neural-network).
