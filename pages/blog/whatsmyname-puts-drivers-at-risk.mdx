...
import driver from "../../public/images/victor-xok-qd-zd2MoeE8-unsplash.jpg";
import cars from "../../public/images/thought-catalog-x5GdvJ-taiQ-unsplash.jpg";
...
<Figure className="full-width mt-2 mb-4">
  <FigureImage src={cars} className="d-block mx-auto" maxWidth={506} />
  <FigureCaption className="sans-serif text-center">
