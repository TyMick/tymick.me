export const metadata = {
  ...
  socialLinks: {
    ...
    linkedin:
      "https://www.linkedin.com/posts/tymick_natural-language-processing-for-loan-risk-activity-6725480058460413952-F1z-",
  },
  syndicated: {
    medium: "https://towardsdatascience.com/loan-risk-nlp-d98021613ff3",
    dev:
      "https://dev.to/tymick/natural-language-processing-for-loan-risk-3m1k",
    hackerNoon: null,
  },
  ipynb: true,
};
...
or
[GitHub](https://github.com/TyMick/loan-risk-neural-network/blob/master/models/loan-risk-nlp.ipynb "loan-risk-neural-network/loan-risk-nlp.ipynb at master · TyMick/loan-risk-neural-network")
